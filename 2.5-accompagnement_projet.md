...
|Niveau d'autonomie|Argumenter l'interet pour un projet|Structurer un projet|S'exercer pour lancer un projet|Construire dans le respect des normes|Atteindre et maintenir les meilleurs standards|
|------|------|-----|-----|-----|-----|
