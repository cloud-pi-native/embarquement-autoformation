...
|Comprendre l'interet pour un projet|Structurer un projet|S'exercer pour lancer un projet|Construire dans le respectdes normes|Atteindre et maintenir les meilleurs standards|
| ------|-----|-----|-----|-----|
