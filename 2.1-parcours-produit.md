...
Ce parcours s'adresse aux équipes projet/produit: développeurs, architectes solution, intégrateurs... qui livrent du code applicatif. 

L'objectif est de leur permettre de s'appuyer sur les moyens d'une plateforme de livraison DevSecOps proposant des outils d'intégration et de déploiement au standard et à l’état de l’art.
