...
- Absence d’un système de normes commun à l’innovation et au développement de grosse solution. (impossibilité de croître)
...
### Guide pratique de l'offre Cloud Pi Native
L'objectif du guide pratique est de centraliser l’ensemble des ressources nécessaire à la montée en compétence des équipes technique, métier, et transverse en proposant des ressources de divers format et adaptées à toute l’organisation.
- Page d'acceuil du guide utilisateur (étapes du montage et de la gestion d'un projet, introduction au CCT)
- Documentation technique de Cloud Pi Native (socle, console, ...)
- Utilisation de Cloud Pi Native dans le contexte du Ministère de l'Interieur (liens catalogue)
