...
- *Pour des démarches partenariales structurés*: que vous soyez acteur ministériel, industriel ou contributeur de l'Open Source, vous pouvez prendre contact avec nos équipes via l'adresse cloudpinative-relations@interieur.gouv.fr pour nous faire part de votre démarche d'expérimentation. AUCUNE démarche à visée commerciale ne sera examinée ;
