...
Nous vous invitons à prendre connaissance des principes et exigences sous-jacents, exposés dans le [cadre de cohérence technique Cloud Pi Native (CCT)](https://github.com/dnum-mi/CCT-Cloud-Native). De ces principes découleront les technologies, bonnes pratiques, organisations, processus... préconisés pour livrer des produits numériques de qualité et les gérer tout au long de leur cycle de vie.
