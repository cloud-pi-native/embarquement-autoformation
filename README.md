...
Pour réussir ce projet de transformation au service des usagers, le numérique public doit également inclure les développeurs, usagers trop souvent oubliés. La voie privilégiée que nous proposons emprunte aux technologies ["cloud native"](https://github.com/Yoarmi/dso-formation/blob/patch-1/1.2-technologies-cloud-native.md) (conteneurisation, API, microservices), à l'organisation en [mode produit](https://github.com/Yoarmi/dso-formation/blob/patch-1/1.1-approche_devsecops.md) (évolution continue) et aux approches [DevSecOps](https://github.com/Yoarmi/dso-formation/blob/patch-1/1.1-approche_devsecops.md) (culture de responsabilités partagées).
Le socle proposé ici vise à "matérialiser" cette approche par la mise en place d'un flux de production intégré, continu, optimisé (lean-agile).
...
Nous vous invitons à prendre connaissance des principes et exigences exposés dans le [cadre de cohérence technique Cloud Pi Native (CCT)](https://github.com/dnum-mi/CCT-Cloud-Native), découlant de la doctrine cloud au centre de l’Etat, qui décrit [le socle technique et le « modèle organisationnel](https://github.com/Yoarmi/dso-formation/blob/patch-1/2-modele_organisation.md) » pour les différentes parties prenantes. 

Comme tout dispositif industriel, une certaines distribution des roles et des périmètres de responsabilité est nécessaire pour en tirer le plein potentiel. Le socle et le modèle permettent d'optimiser les compétences et processus à mettre en place pour livrer et gérer des produits numériques tout au long de leur cycle de vie.
