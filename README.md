...
|5|[Comment garantir, en évolution permanente, l'intégration, le suivi et la pérénnité des bonnes pratiques tout en restant en maitrise des standards?](./formation_step5.md) |Manager un patrimoine numérique pour rester autonome et performant sur la durée (anti patterns, organisation en mode produit et cloud-agile)|Tirer le plein potentiel et contribuer aux technologies du CNCF Landscape (dont charts helms/operators)|Assurer la disponibilité et la continuité, MCO/MCS, garder des options ouvertes sur les transitions futures|
