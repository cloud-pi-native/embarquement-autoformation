...
### Un "nouveau monde" logiciel a émergé
 Dans ce nouveau cadre, certains produits/services deviennent des « normes de fait »: les décisions les concernant, leurs caractéristiques, impactent des millions d'utilisateurs et posent des [défis importants aux organisations publiques](https://github.com/Yoarmi/dso-formation/blob/patch-1/1.3-defi_service_public.md). Dans ce nouveau cadre, le secteur public doit réaliser une transformation numérique au service de ses usagers et agents: c'est à dire en se dotant des moyens de s'approprier les outis et les normes du numérique. 
