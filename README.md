...
- **Pour des démarches partenariales structurés**: que vous soyez acteur ministériel, industriel ou contributeur de l'Open Source, vous pouvez nous faire part de votre démarche/proposition d'expérimentation via l'adresse cloudpinative-relations@interieur.gouv.fr. Nos équipes n'examineront et ne répondront à AUCUNE démarche à visée commerciale ;
